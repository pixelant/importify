    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_importify_domain_model_import',
                'foreign_table_where' => 'AND tx_importify_domain_model_import.pid=###CURRENT_PID### AND tx_importify_domain_model_import.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
